...
<div class="row">
  <div class="col-lg-12">
    ...
    <ul class="nav nav-tabs">
       <li class="active"><a href="#todo" data-toggle="tab"><span class="fa fa-exclamation-circle"></span> Tarefas Para Fazer</a>
       </li>
       <li><a href="#done" data-toggle="tab"><span class="fa fa-check-circle"></span> Tarefas Concluídas</a>
       </li>
    </ul>
